...
public class htmlContentParser {
        public static void main (String[] args) throws IOException {
                ...
                URL address = new URL("http://www.crh.noaa.gov/product.php?site=NWS&issuedby=GJT&product=AFD&format=TXT&version=1&glossary=0");
                ...
                Matcher mspre = pre.matcher(content);               
                while (mspre.find()) content = mspre.replaceAll("aaa");
